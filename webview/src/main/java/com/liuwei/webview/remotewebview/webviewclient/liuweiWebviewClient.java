package com.liuwei.webview.remotewebview.webviewclient;
...
import static com.liuwei.webview.remotewebview.BaseWebView.CONTENT_SCHEME;

public class liuweiWebviewClient extends WebViewClient {
    ...
    public liuweiWebviewClient(WebView webView, WebViewCallBack webViewCallBack, Map<String, String> headers, WebviewTouch touch){

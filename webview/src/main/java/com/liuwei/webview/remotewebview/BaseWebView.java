package com.liuwei.webview.remotewebview;
...
import com.liuwei.webview.remotewebview.commanddispatcher.CommandDispatcher;
import com.liuwei.webview.remotewebview.callback.WebViewCallBack;
import com.liuwei.webview.remotewebview.settings.WebviewDefaultSetting;
import com.liuwei.webview.remotewebview.webviewclient.liuweiWebviewClient;

import java.util.HashMap;
import java.util.Map;

public class BaseWebView extends WebView implements liuweiWebviewClient.WebviewTouch {
    private static final String TAG = "liuweiWebView";
    ...
    public void registerdWebViewCallBack(WebViewCallBack webViewCallBack) {
        ...
        setWebViewClient(new liuweiWebviewClient(this, webViewCallBack, mHeaders, this));
    }
